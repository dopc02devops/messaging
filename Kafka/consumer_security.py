...
# Prometheus metrics
messages_consumed = Counter('kafka_security_consumer_messages_total', 'Total number of messages consumed')
message_processing_duration = Summary('kafka_security_consumer_duration_seconds', 'Time taken to process a message')
